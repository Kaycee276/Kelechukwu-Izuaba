...
export default async function ProjectsPage() {
  let projectItems: ProjectItem[] = fallbackProjects;
  ...
  try {
    ...
    console.error("Database query fallback engaged for Projects page:", err);
  }

  return <ProjectsClient projects={projectItems} />;
}
